...
?>
    <h3 class="section-title wow fadeIn"><?php echo esc_html( get_theme_mod( 'crafter_blog_title', __( 'From The Blog', 'crafter' ) ) ); ?></h3>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class('blog-item wow fadeIn');  echo $blog_image; ?>>
                ...
                <div class="blog-item-entry">
                    ...
                    <div class="entry-half2">
                        <?php the_title( sprintf( '<h2 class="blog-item-title"><a class="wrapperhref" href="%s" rel="bookmark">', esc_url( get_permalink() ) ), '</a></h2>' ); ?>
                        <?php
                        $byline = sprintf(
