...
The option can be found under `example.com/wp-admin/options-writing.php`.
...
= 1.1.0 =
* Added: Removal of WordPress 4.7 Emoji CDN DSN prefetch URL generation. Thanks [Piet Bos](https://profiles.wordpress.org/senlin/)!
...
= 1.0.5 =
* Fixed: New WordPress installations (4.3 and up) don't have the option to turn off smileys. This leads to incorrect character encoding of smiley abbreviations, like :) and :D. Therefor the whole function to encode characters will be removed if emoji's are set to disabled.
...
Add any of these filter functions to your theme functions.php or template file, or a separate plugin.
